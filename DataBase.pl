...
menuKeto1():-nl, writeln("Desayuno"),nl,
                ...
                nl, writeln("Merienda"),nl,
                nl, writeln("100g de cecina o jamon"),nl,
                nl, writeln("****************"),nl,

                nl, writeln("Cena"),nl,
                nl, writeln("150g de ternera"),nl,
                nl, writeln("60g de col pak choi"),nl,
                nl, writeln("2 unidades de citronela"),nl,
                nl, writeln("1 manzana con canela"),nl,
                nl, writeln("Medio pimiento rojo"),nl,
                nl, writeln("50g de kale"),nl,
...
%Detalles de la dieta keto kcal
menuKeto1():-nl, writeln("Desayuno"),nl,
                nl, writeln("250 gr de yogur de coco"),nl,
                nl, writeln("1 cucharada de proteína"),nl,
                nl, writeln("30g de almendras"),nl,
                nl, writeln("20g de mantequilla"),nl,
                nl, writeln("****************"),nl,

                nl, writeln("Merienda"),nl,
                nl, writeln("100g de cecina o jamón"),nl,
                nl, writeln("****************"),nl,

                nl, writeln("Almuerzo"),nl,
                nl, writeln("Ensalada de pastrami"),nl,                
                nl, writeln("50 gr de crema de queso"),nl,                        
                nl, writeln("****************"),nl,

                nl, writeln("Merienda"),nl,
                nl, writeln("Brócoli picante"),nl,
                nl, writeln("80g de brócoli asado"),nl,
                nl, writeln("10g de chile cortados en trozos y asados"),nl,
                nl, writeln("****************"),nl,

                nl, writeln("Cena"),nl,
                nl, writeln("Gambas con arroz de coliflor"),nl,
                nl, writeln("100g de coliflor"),nl,
                nl, writeln("1 cucharada de aceite de coco"),nl,
                nl, writeln("50g de judías verdes"),nl,
                nl, writeln("150g de gambas"),nl,
                nl, writeln("50g de crema de queso"),nl,
                nl, writeln("1 puñado de cacahuetes machacados"),nl,
                nl, writeln("10g de cebollino"),nl,
